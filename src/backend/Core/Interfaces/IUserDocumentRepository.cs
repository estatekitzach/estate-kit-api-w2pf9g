...
namespace EstateKit.Core.Interfaces
{
    ...
    public interface IUserDocumentRepository
    {
        ...
        /// </summary>
        /// <param name="userDocument">The document to add</param>
        ...
        /// </remarks>
        Task<UserDocument> AddAsync(UserDocument userDocument);

        /// <summary>
        /// Updates an existing document in the repository while maintaining field-level encryption.
        /// </summary>
        /// <param name="userDocument">The document with updated information</param>
        ...
        /// </remarks>
        Task<bool> UpdateAsync(UserDocument userDocument);
        ...
        /// </remarks>
        Task<bool> UpdateProcessingStatusAsync(int id, string metadata);
